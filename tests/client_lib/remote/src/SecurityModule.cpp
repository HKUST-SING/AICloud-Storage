...
SecurityModule::closeSecurityModule()
{
  ...
  LOG(INFO) << "SecurityModule::closeSecurityModule";
...
SecurityModule::processClientTasks()
{
  ...
  { // keep issueing tasks
    ...
    {
      LOG(INFO) << "SecurityModule::processClientTasks: "
                << "received MessageSource::MSG_TERM";
...
SecurityModule::queryServerChannel()
{
  ...
  { 
    ...
    LOG(INFO) << "SecurityModule::queryServerChannel: "
               << "received respones from the server";
                             ...
                             std::unique_ptr<Response>&& resValue)
{
  ...
  LOG(INFO) << "SecurityModule::processServerResponse";
  ...
  LOG(INFO) << "SecurityModule::processServerResponse: "
            << "stateCode_ = " << static_cast<unsigned int>(resValue->stateCode_);
  ...
  if(resValue->stateCode_ != CommonCode::IOStatus::ERR_INTERNAL)
  {
    ...
    else
    {
      ...
      try
      {
        ...
        LOG(INFO) << "SecurityModue::processServerResponse: "
                  << "found 'Result'";
...
SecurityModule::joinService()
{
  ...
  LOG(INFO) << "SecurityModule::joinService";
  ...
  LOG(INFO) << "SecurityModule::joinService: exiting joinService.";
...
SecurityModule::destroy()
{
  ...
  LOG(INFO) << "SecurityModule::destroy";
  ...
  LOG(INFO) << "SecurityModule::destroy: exiting destroy.";
