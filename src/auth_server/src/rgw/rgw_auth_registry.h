...
class StrategyRegistry {
  ...
  /* Custom strategy */
  rgw::auth::singstorage::DefaultStrategy sing_strategy_;
...
public:
  ...
  const rgw::auth::singstorage::DefaultStrategy& get_sing() const
  {
    return sing_strategy_;
  }
